...
export default function TripForm({ onSubmitSuccess }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (onSubmitSuccess) onSubmitSuccess(); // chiudi modale se serve
  };
          ...
          {participants.map((p) => (
            <div className="col-6 col-md-4" key={p.id}>
              <div className="form-check">
                ...
                />
                <label className="form-check-label" htmlFor={`participant-${p.id}`}>
